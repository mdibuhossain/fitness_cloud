            ...
            <Grid sx={{py:8}} container spacing={4}>
                <Grid item lg={6} md={6} sm={12} xs={12}
                 sx={{display:"flex",flexDirection:"column",justifyContent:"center"}}>
                    ...
                    <Typography sx={{py:2,textAlign:"justify"}} variant="body1">Many women and some men too, use to worry that lifting weights could make them look too muscly but this isn’t the case with Strength & Conditioning. Focussing on low repetitions at a higher weight builds long-length strength fibres and doesn’t bulk. 
                    <br /> <br />
        ...
        <Container sx={{pb:10}}>
          ...
          <Grid container spacing={4}>
            <Grid item lg={6} md={6} sm={12} xs={12}>
              ...
              <TextField required sx={{my:4}} fullWidth label="Email" id="fullWidth" />
              <TextField fullWidth label="Schedule" id="fullWidth" />
            </Grid>
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <TextField required fullWidth label="Phone" id="fullWidth" />
              <TextField required sx={{my:4}}  multiline
              rows={4} fullWidth label="Your Message" id="fullWidth" />
                <button type="submit" className="slide-button">$<span>10</span> Take Class +</button>
            </Grid>
          </Grid>
          </form>
        </Container>
