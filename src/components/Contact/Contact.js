  ...
  return (
    <div>
      <div id="cover" style={banner}>
        ...
        <div id="Map">
          <iframe style={{width:"100%",height:"450px",border:"0"}} title="location"  src="https://maps.google.com/maps?q=london,New York&t=k&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
            </iframe>
        </div>
